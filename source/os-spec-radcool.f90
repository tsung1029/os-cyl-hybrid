	...
	select case ( this%coordinates )
	 ...
	 case default
	   select case ( p_x_dim )
		...
		!case (1)
		!  call advance_deposit_radcool_1d( this, emf, jay(tid+1), dtcycle, omega_p0, i0, i1 )

		case (2)
		  call advance_deposit_radcool_2d( this, emf, jay(tid+1), dtcycle, omega_p0, i0, i1 )

		case (3)
		  call advance_deposit_radcool_3d( this, emf, jay(tid+1), dtcycle, omega_p0, i0, i1 )
...
!       local variables
  ...
  do ptrcur = i0, i1, p_cache_size
	 ...
	 !!!!!!!!!!!!!!!!!!!!
	 call get_emf( emf, bp, ep, ixtemp, xtemp, np, &
				   this%interpolation, this%subcycle )
