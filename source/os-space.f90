...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!
! $URL: https://osiris.ist.utl.pt/svn/branches/dev_3.0/source/os-space.f90 $
! $Id: os-space.f90 484 2012-10-02 15:00:23Z zamb $
!
...
type :: t_space
 ...
 !         information on motion of the simulation box
   ...
   real(p_double) :: move_vel
   
 
   ! original positions of simulation box at first time step
   real(p_double), dimension(2,p_max_dim) :: x_bnd_initial
...
public :: xmin, xmax, x_bnd, get_x_bnd, extend
