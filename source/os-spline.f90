! spline class
!
! $URL: https://osiris.ist.utl.pt/svn/branches/dev_3.0/source/os-spline.f90 $
! $Id: os-spline.f90 379 2011-07-06 15:29:01Z zamb $
!
...
! use these things when we put it in OSIRIS
use m_system
use m_parameters
